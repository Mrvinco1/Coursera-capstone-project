...
--ANALYSIS OF CYCLYSTIC BIKE-SHARE DATA FOR JUN2022

SELECT *
  FROM [bike_share_database].[dbo].[202206-full]

  Drop Table if exists bikesharejun
  Create Table bikesharejun
     (
...
FROM [bike_share_database].[dbo].[UserS_ridetime6]
...
--conducted on the cyclystic bike-share company Jun2022 data Using Microsoft SQL Server, 
