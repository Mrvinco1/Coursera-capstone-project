--ANALYSIS OF CYCLYSTIC BIKE-SHARE DATA FOR OCT2022

SELECT  *
  FROM [bike_share_database2].[dbo].[202210-full]

 Drop Table if exists bikeshareoct
  Create Table bikeshareoct
     (
...
Insert Into bikeshareoct
  SELECT
      ...
      ,[weekday]
	  FROM 
	  bike_share_database2..[202210-full]
...
FROM [bike_share_database2].[dbo].[UserS_ridetime10]
...
--conducted on the cyclystic bike-share company October2022 data Using Microsoft SQL Server, 
