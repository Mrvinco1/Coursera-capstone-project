...
--ANALYSIS OF CYCLYSTIC BIKE-SHARE DATA FOR NOV2022

SELECT  *
  FROM [bike_share_database2].[dbo].[202211-full]

 --Create a comprehensive table bikesharenov

 Drop Table if exists bikesharenov
  Create Table bikesharenov
...
--Insert into table bikesharenov

Insert Into bikesharenov
  SELECT
       [ride_id]
      ,[rideable_type]
      ,[started_at]
      ...
      ,[weekday]
	  FROM 
	  bike_share_database2..[202211-full]

-- Explore the table bikesharenov 
Select *
From bikesharenov
--- Total unique Users
...
FROM [bike_share_database2].[dbo].[UserS_ridetime11]
...
--conducted on the cyclystic bike-share company November2022 data Using Microsoft SQL Server, 
